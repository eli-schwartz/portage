...
from portage.util.elf.constants import (
    EF_MIPS_ABI, EF_MIPS_ABI2, EF_RISCV_FLOAT_ABI_DOUBLE, EF_RISCV_RVC,
    EF_LOONGARCH_ABI_LP64_SOFT_FLOAT, EF_LOONGARCH_ABI_LP64_SINGLE_FLOAT,
    EF_LOONGARCH_ABI_LP64_DOUBLE_FLOAT, EF_LOONGARCH_ABI_ILP32_SOFT_FLOAT,
    EF_LOONGARCH_ABI_ILP32_SINGLE_FLOAT, EF_LOONGARCH_ABI_ILP32_DOUBLE_FLOAT, EF_LOONGARCH_ABI_MASK,
    ELFCLASS32, ELFCLASS64, EM_386, EM_68K, EM_AARCH64, EM_ALPHA, EM_AMDGPU, EM_ARM,
    EM_ALTERA_NIOS2, EM_IA_64, EM_LOONGARCH, EM_MIPS, EM_PARISC, EM_PPC, EM_PPC64, EM_RISCV,
    EM_S390, EM_SH, EM_SPARC, EM_SPARC32PLUS, EM_SPARCV9, EM_X86_64, E_MIPS_ABI_EABI32,
