...
class NewsItemTestCase(TestCase):
    ...
    placeholders = {
        "title":
        "YourSQL Upgrades from 4.0 to 4.1",
        "author":
    ...
    def testDisplayIfInstalled(self):
        ...
        self._checkAndCreateNewsItem({"display_if_installed": ["sys-apps/i-do-not-exist"]}, False)
    ...
    def testDisplayIfKeyword(self):
        ...
        self._checkAndCreateNewsItem({"display_if_keyword": [self.keywords, "amd64", "~hppa"]})
