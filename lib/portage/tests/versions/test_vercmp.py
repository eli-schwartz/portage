...
class VerCmpTestCase(TestCase):
    ...
    def testVerCmpLess(self):
        ...
        tests = [("4.0", "5.0"), ("5", "5.0"), ("1.0_pre2", "1.0_p2"), ("1.0_alpha2", "1.0_p2"),
                 ...
                 ("1.01", "1.1"), ("1.0-r0", "1.0-r1"), ("1.0", "1.0-r1"), ("1.0", "1.0.0"),
    ...
    def testVerCmpEqual(self):
        tests = [("4.0", "4.0"), ("1.0", "1.0"), ("1.0-r0", "1.0"), ("1.0", "1.0-r0"),
                 ("1.0-r0", "1.0-r0"), ("1.0-r1", "1.0-r1"), ]
        for test in tests:
            self.assertFalse(vercmp(test[0], test[1]) != 0, msg=f"{test[0]} != {test[1]}? Wrong!", )

    def testVerNotEqual(self):
        tests = [("1", "2"), ("1.0_alpha", "1.0_pre"), ("1.0_beta", "1.0_alpha"), ("0", "0.0"),
                 ("1.0-r0", "1.0-r1"), ("1.0-r1", "1.0-r0"), ("1.0", "1.0-r1"), ("1.0-r1", "1.0"),
                 ("1.0", "1.0.0"), ("1_p1", "1b_p1"), ("1b", "1"), ("1.1b", "1.1"),
                 ("12.2b", "12.2"), ]
        for test in tests:
            self.assertFalse(vercmp(test[0], test[1]) == 0, msg=f"{test[0]} == {test[1]}? Wrong!", )
