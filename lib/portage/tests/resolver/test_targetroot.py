...
class TargetRootTestCase(TestCase):
    ...
    def testTargetRoot(self):
        ...
        installed = {"dev-lang/python-3.2": {"EAPI": "7", "BDEPEND": "~dev-lang/python-3.2", }, }

        test_cases = (ResolverPlaygroundTestCase(["dev-lang/python"],
                                                 options={},
                                                 success=True,
                                                 mergelist=["dev-lang/python-3.2{targetroot}"],
                                                 ),
                      ResolverPlaygroundTestCase(["dev-lang/python"],
