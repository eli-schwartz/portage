...
class OrUpgradeInstalledTestCase(TestCase):
    ...
    def testOrUpgradeInstalled(self):
        ...
        installed = {"sys-libs/glibc-2.24": {"EAPI": "6", "IUSE": "+rpc", "USE": "rpc", }, }
        ...
        test_cases = (ResolverPlaygroundTestCase(["net-misc/foo", "@world"],
                                                 options={
                                                     "--update": True,
                                                     "--deep": True
                                                 },
                                                 success=True,
                                                 mergelist=["net-misc/foo-1", ],
                                                 ), )
    ...
    def testVirtualRust(self):
        ...
        test_cases = (
            ...
            # available.
            ResolverPlaygroundTestCase(["virtual/rust"],
                                       options={
                                           "--update": True,
                                           "--deep": True
                                       },
            ...
            # virtual/rust-1.19.0.
            ResolverPlaygroundTestCase(["=dev-lang/rust-1.23.0", "virtual/rust"],
                                       options={
                                           "--update": True,
                                           "--deep": True
                                       },
