...
class EAPITestCase(TestCase):
    ...
    def testEAPI(self):
        ...
        test_cases = (
            ...
            ResolverPlaygroundTestCase(["=dev-libs/A-1.1"],
                                       success=True,
                                       mergelist=["dev-libs/A-1.1"]),
            ResolverPlaygroundTestCase(["=dev-libs/A-1.2"],
                                       success=True,
                                       mergelist=["dev-libs/A-1.2"]),
            ResolverPlaygroundTestCase(["=dev-libs/A-1.3"],
                                       success=True,
                                       mergelist=["dev-libs/A-1.3"]),
            ResolverPlaygroundTestCase(["=dev-libs/A-1.4"],
                                       success=True,
                                       mergelist=["dev-libs/A-1.4"]),
            ...
            ResolverPlaygroundTestCase(["=dev-libs/A-4.2"],
                                       success=True,
                                       mergelist=["dev-libs/A-4.2"]),
            ResolverPlaygroundTestCase(["=dev-libs/A-4.3"],
                                       success=True,
                                       mergelist=["dev-libs/A-4.3"]),
            ResolverPlaygroundTestCase(["=dev-libs/A-4.4"],
                                       success=True,
                                       mergelist=["dev-libs/A-4.4"]),
            ...
            ResolverPlaygroundTestCase(["=dev-libs/A-7.4"],
                                       success=True,
                                       mergelist=["dev-libs/A-7.4"]),
