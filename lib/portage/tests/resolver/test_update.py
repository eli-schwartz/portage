...
class UpdateIfInstalledTestCase(TestCase):
    ...
    def testUpdateIfInstalledEmerge(self):
        ...
        test_cases = (
            ...
            ResolverPlaygroundTestCase(["dev-lang/ghc"],
            ...
            ResolverPlaygroundTestCase(["dev-lang/ghc", "virtual/libc"],
                                       mergelist=["dev-lang/ghc-5"],
                                       options={
                                           "--update-if-installed": True,
                                       },
            ...
            ResolverPlaygroundTestCase(["virtual/libc"],
                                       mergelist=[],
                                       options={
                                           "--update-if-installed": True,
                                       },
            ...
            ResolverPlaygroundTestCase(["app-misc/cowsay"],
                                       mergelist=[],
                                       options={
                                           "--update-if-installed": True,
                                       },
            ...
            ResolverPlaygroundTestCase(["app-misc/cowsay", "dev-libs/larryware"],
            ...
            ResolverPlaygroundTestCase(["dev-libs/larryware-ng"],
