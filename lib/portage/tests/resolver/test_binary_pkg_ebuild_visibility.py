...
class BinaryPkgEbuildVisibilityTestCase(TestCase):
    ...
    def testBinaryPkgEbuildVisibility(self):
        binpkgs = {"app-misc/foo-3": {}, "app-misc/foo-2": {}, "app-misc/foo-1": {}, }

        ebuilds = {"app-misc/foo-2": {}, "app-misc/foo-1": {}, }

        installed = {"app-misc/foo-1": {}, }
        ...
        test_cases = (
            ...
            ResolverPlaygroundTestCase(["@world"],
                                       ...
                                       success=True,
                                       mergelist=["[binary]app-misc/foo-3", ],
                                       ),
            ResolverPlaygroundTestCase(["@world"],
                                       options={
                                           "--update": True,
            ...
            ResolverPlaygroundTestCase(["=app-misc/foo-3"],
                                       options={
                                           "--use-ebuild-visibility": "y",
                                           "--usepkgonly": True,
                                       },
            ...
            ResolverPlaygroundTestCase(["app-misc/foo"],
                                       options={
                                           "--use-ebuild-visibility": "y",
                                           "--usepkgonly": True,
                                       },
