...
class MergeOrderTestCase(TestCase):
    ...
    def testMergeOrder(self):
        ...
        test_cases = (
            ...
            ResolverPlaygroundTestCase(["app-misc/circ-buildtime-unsolvable-a"],
                                       success=False,
            ...
            ResolverPlaygroundTestCase(["app-misc/blocker-runtime-a", "app-misc/blocker-runtime-b"],
                                       success=True,
                                       all_permutations=True,
                                       ambiguous_merge_order=True,
            ...
            # TODO: distinguish between install/uninstall tasks in mergelist
            ResolverPlaygroundTestCase(["app-misc/blocker-buildtime-unbuilt-a"],
                                       success=True,
                                       mergelist=[
                                           "app-misc/blocker-buildtime-unbuilt-a-1",
                                           "[uninstall]app-misc/installed-blocker-a-1",
            ...
            ResolverPlaygroundTestCase(["app-misc/blocker-buildtime-unbuilt-hard-a"],
                                       success=False,
                                       mergelist=[
                                           "app-misc/blocker-buildtime-unbuilt-hard-a-1",
                                           "!!app-misc/installed-blocker-a",
