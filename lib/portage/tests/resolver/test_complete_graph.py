...
class CompleteGraphTestCase(TestCase):
    ...
    def testCompleteGraphUseChange(self):
        ...
        test_cases = (ResolverPlaygroundTestCase(["dev-libs/libxml2"],
                      ...
                      ResolverPlaygroundTestCase(["dev-libs/libxml2"],
    ...
    def testCompleteGraphVersionChange(self):
        ...
        test_cases = (ResolverPlaygroundTestCase([">=sys-libs/x-2"],
                                                 options={
                      ...
                      ResolverPlaygroundTestCase([">=sys-libs/x-2"],
                                                 options={"--ignore-world": True},
                                                 mergelist=["sys-libs/x-2"],
                                                 success=True,
                                                 ),
                      ...
                      ResolverPlaygroundTestCase(["<sys-libs/x-1"],
                                                 options={
                                                     "--complete-graph-if-new-ver": "n",
                                                     "--rebuild-if-new-slot": "n",
                                                 },
