...
class AutounmaskTestCase(TestCase):
    ...
    def testAutounmask(self):
        ebuilds = {
            ...
            "sci-libs/K-2": {
                "DEPEND": " || ( sci-libs/L[bar] || ( sci-libs/P sci-libs/M ) )",
                "EAPI": 2,
            },
            "sci-libs/K-3": {
                "DEPEND": " || ( sci-libs/M || ( sci-libs/L[bar] sci-libs/P ) )",
                "EAPI": 2,
            },
            "sci-libs/K-4": {
                "DEPEND": " || ( sci-libs/M || ( sci-libs/P sci-libs/L[bar] ) )",
                "EAPI": 2,
            },
            "sci-libs/K-5": {
                "DEPEND": " || ( sci-libs/P || ( sci-libs/L[bar] sci-libs/M ) )",
                "EAPI": 2,
            },
            "sci-libs/K-6": {
        ...
        test_cases = (
            ...
            # required by dev-libs/A:1 (argument)
            # >=dev-libs/B-1 foo
            ResolverPlaygroundTestCase(["dev-libs/A:1", "dev-libs/A:2", "dev-libs/B"],
                                       options={
                                           "--autounmask": True,
                                           "--autounmask-backtrack": "y"
                                       },
            ...
            ResolverPlaygroundTestCase(["=app-misc/V-1", "app-misc/W"],
                                       options={"--autounmask": True},
                                       all_permutations=True,
                                       success=False,
            ...
            ResolverPlaygroundTestCase(["=sci-libs/K-1"],
                                       options={"--autounmask": True},
                                       success=True,
                                       mergelist=["sci-libs/P-1", "sci-libs/K-1"],
                                       ),
            ResolverPlaygroundTestCase(["=sci-libs/K-2"],
                                       options={"--autounmask": True},
                                       success=True,
                                       mergelist=["sci-libs/P-1", "sci-libs/K-2"],
                                       ),
            ResolverPlaygroundTestCase(["=sci-libs/K-3"],
                                       options={"--autounmask": True},
                                       success=True,
                                       mergelist=["sci-libs/P-1", "sci-libs/K-3"],
                                       ),
            ResolverPlaygroundTestCase(["=sci-libs/K-4"],
                                       options={"--autounmask": True},
                                       success=True,
                                       mergelist=["sci-libs/P-1", "sci-libs/K-4"],
                                       ),
            ResolverPlaygroundTestCase(["=sci-libs/K-5"],
                                       options={"--autounmask": True},
                                       success=True,
                                       mergelist=["sci-libs/P-1", "sci-libs/K-5"],
                                       ),
            ResolverPlaygroundTestCase(["=sci-libs/K-6"],
                                       options={"--autounmask": True},
                                       success=True,
                                       mergelist=["sci-libs/P-1", "sci-libs/K-6"],
                                       ),
            # Make sure we prefer use changes over keyword changes.
            ResolverPlaygroundTestCase(["=sci-libs/K-7"],
                                       options={"--autounmask": True},
                                       success=False,
            ...
            ResolverPlaygroundTestCase(["=sci-libs/K-8"],
                                       options={"--autounmask": True},
                                       success=False,
            ...
            ResolverPlaygroundTestCase(["=dev-util/Q-1"],
                                       options={"--autounmask": True},
                                       success=False,
            ...
            ResolverPlaygroundTestCase(["=dev-util/Q-2"],
                                       options={"--autounmask": True},
                                       success=False,
            ...
            ResolverPlaygroundTestCase(["sci-mathematics/octave"],
                                       options={"--autounmask": True},
        ...
        profile = {
            ...
            "package.mask": ("app-text/A", "app-text/B", "app-text/C",
                             ),
        }
    ...
    def testAutounmaskForLicenses(self):
        ...
        test_cases = (
            ...
            ResolverPlaygroundTestCase(["dev-java/sun-jdk"],
                                       options={"--autounmask": True},
                                       success=False,
    ...
    def testAutounmaskAndSets(self):
        ...
        world_sets = ["@test-set"]
        sets = {"test-set": ("dev-libs/A", "dev-libs/B", "dev-libs/C", "dev-libs/D", ), }
    ...
    def testAutounmaskKeepMasks(self):
        ...
        profile = {"package.mask": ("app-text/A", ), }
    ...
    def testAutounmask9999(self):
        ...
        profile = {"package.mask": (">=dev-libs/A-2", ), }

        test_cases = (ResolverPlaygroundTestCase(["dev-libs/B"],
                                                 success=False,
                                                 options={"--autounmask": True},
