...
class IsValidAtom(TestCase):
    ...
    def testIsValidAtom(self):
        test_cases = (
            IsValidAtomTestCase("sys-apps/portage",
                                True), IsValidAtomTestCase("=sys-apps/portage-2.1", True),
            IsValidAtomTestCase("=sys-apps/portage-2.1*",
                                True), IsValidAtomTestCase(">=sys-apps/portage-2.1", True),
            IsValidAtomTestCase("<=sys-apps/portage-2.1",
                                True), IsValidAtomTestCase(">sys-apps/portage-2.1", True),
            IsValidAtomTestCase("<sys-apps/portage-2.1",
                                True), IsValidAtomTestCase("~sys-apps/portage-2.1", True),
            IsValidAtomTestCase("sys-apps/portage:foo",
                                True), IsValidAtomTestCase("sys-apps/portage-2.1:foo", False),
            IsValidAtomTestCase("sys-apps/portage-2.1:",
                                False), IsValidAtomTestCase("sys-apps/portage-2.1:", False),
            IsValidAtomTestCase("sys-apps/portage-2.1:[foo]",
                                False), IsValidAtomTestCase("sys-apps/portage", True),
            IsValidAtomTestCase("sys-apps/portage",
                                True), IsValidAtomTestCase("sys-apps/portage", True),
            IsValidAtomTestCase("sys-apps/portage",
                                True), IsValidAtomTestCase("sys-apps/portage", True),
            IsValidAtomTestCase("sys-apps/portage",
                                True), IsValidAtomTestCase("sys-apps/portage", True),
            IsValidAtomTestCase("=sys-apps/portage-2.2*:foo[bar?,!baz?,!doc=,build=]",
                                True), IsValidAtomTestCase("=sys-apps/portage-2.2*:foo[doc?]",
                                                           True),
            ...
            IsValidAtomTestCase("=sys-apps/portage-2.2*:foo[,bar,-baz,doc?,!build?]", False),
            IsValidAtomTestCase("=sys-apps/portage-2.2*:foo[bar,-baz][doc?,!build?]", False),
            IsValidAtomTestCase("=sys-apps/portage-2.2*:foo[bar][doc,build]",
                                False), IsValidAtomTestCase(">~cate-gory/foo-1.0", False),
            IsValidAtomTestCase(">~category/foo-1.0",
                                False), IsValidAtomTestCase("<~category/foo-1.0", False),
            IsValidAtomTestCase("###cat/foo-1.0",
                                False), IsValidAtomTestCase("~sys-apps/portage", False),
            IsValidAtomTestCase("portage", False), IsValidAtomTestCase("=portage", False),
            IsValidAtomTestCase(">=portage-2.1", False), IsValidAtomTestCase("~portage-2.1", False),
            IsValidAtomTestCase("=portage-2.1*", False), IsValidAtomTestCase("null/portage", True),
            IsValidAtomTestCase("null/portage*:0",
                                False), IsValidAtomTestCase(">=null/portage-2.1", True),
            IsValidAtomTestCase(">=null/portage",
                                False), IsValidAtomTestCase(">null/portage", False),
            IsValidAtomTestCase("=null/portage*",
                                False), IsValidAtomTestCase("=null/portage", False),
            IsValidAtomTestCase("~null/portage",
                                False), IsValidAtomTestCase("<=null/portage", False),
            IsValidAtomTestCase("<null/portage",
                                False), IsValidAtomTestCase("~null/portage-2.1", True),
            IsValidAtomTestCase("=null/portage-2.1*",
                                True), IsValidAtomTestCase("null/portage-2.1*", False),
            IsValidAtomTestCase("app-doc/php-docs-20071125",
                                False), IsValidAtomTestCase("app-doc/php-docs-20071125-r2", False),
            IsValidAtomTestCase("=foo/bar-1-r1-1-r1",
                                False), IsValidAtomTestCase("foo/-z-1", False),
            # These are invalid because pkg name must not end in hyphen
            # followed by numbers
            IsValidAtomTestCase("=foo/bar-1-r1-1-r1",
                                False), IsValidAtomTestCase("=foo/bar-123-1", False),
            IsValidAtomTestCase("=foo/bar-123-1*",
                                False), IsValidAtomTestCase("foo/bar-123", False),
            IsValidAtomTestCase("=foo/bar-123-1-r1",
                                False), IsValidAtomTestCase("=foo/bar-123-1-r1*", False),
            IsValidAtomTestCase("foo/bar-123-r1", False), IsValidAtomTestCase("foo/bar-1", False),
            IsValidAtomTestCase("=foo/bar--baz-1-r1",
                                True), IsValidAtomTestCase("=foo/bar-baz--1-r1", True),
            IsValidAtomTestCase("=foo/bar-baz---1-r1",
                                True), IsValidAtomTestCase("=foo/bar-baz---1", True),
            IsValidAtomTestCase("=foo/bar-baz-1--r1",
                                False), IsValidAtomTestCase("games-strategy/ufo2000", True),
            ...
            IsValidAtomTestCase("foo/666",
                                True), IsValidAtomTestCase("=dev-libs/poppler-qt3-0.11*", True),
            ...
            IsValidAtomTestCase("=sys-apps/portage-2.2*:foo::repo[bar?,!baz?,!doc=,build=]",
                                True,
                                allow_repo=True,
                                ),
            ...
            IsValidAtomTestCase("sys-apps/portage::repo", True, allow_repo=True,
                                eapi="7"), IsValidAtomTestCase("virtual/ffmpeg:0/53", True),
            IsValidAtomTestCase("virtual/ffmpeg:0/53=",
                                True), IsValidAtomTestCase("virtual/ffmpeg:0/53*", False),
            IsValidAtomTestCase("virtual/ffmpeg:=",
                                True), IsValidAtomTestCase("virtual/ffmpeg:0=", True),
            IsValidAtomTestCase("virtual/ffmpeg:*",
                                True), IsValidAtomTestCase("virtual/ffmpeg:0*", False),
