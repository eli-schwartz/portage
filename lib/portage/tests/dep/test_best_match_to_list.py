...
class Test_best_match_to_list(TestCase):
    ...
    def testBest_match_to_list(self):
        tests = [("dev-libs/A-4", [Atom(">=dev-libs/A-3"),
                                   Atom(">=dev-libs/A-2")], [Atom(">=dev-libs/A-3"),
                                                             Atom(">=dev-libs/A-2")], True,
                  ),
                 ("dev-libs/A-4", [Atom("<=dev-libs/A-5"),
                                   Atom("<=dev-libs/A-6")], [Atom("<=dev-libs/A-5"),
                                                             Atom("<=dev-libs/A-6")], True,
                  ),
                 ("dev-libs/A-1", [Atom("dev-libs/A"),
                                   Atom("=dev-libs/A-1")], [Atom("=dev-libs/A-1"),
                                                            Atom("dev-libs/A")], True,
                  ), ("dev-libs/A-1", [Atom("dev-libs/B"), Atom("=dev-libs/A-1:0")], [Atom("=dev-libs/A-1:0")], True,
                      ),
                 ("dev-libs/A-1", [Atom("dev-libs/*", allow_wildcard=True),
                                   Atom("=dev-libs/A-1:0")],
                  [Atom("=dev-libs/A-1:0"), Atom("dev-libs/*", allow_wildcard=True)], True,
                  ),
                 ("dev-libs/A-4.9999-r1",
                  [Atom("dev-libs/*", allow_wildcard=True),
                   Atom("=*/*-*9999*", allow_wildcard=True),
                   ], [Atom("=*/*-*9999*", allow_wildcard=True),
                       Atom("dev-libs/*", allow_wildcard=True), ], True,
                  ),
                 ("dev-libs/A-4_beta-r1",
                  [Atom("dev-libs/*", allow_wildcard=True),
                   Atom("=*/*-*_beta*", allow_wildcard=True),
                   ], [Atom("=*/*-*_beta*", allow_wildcard=True),
                       Atom("dev-libs/*", allow_wildcard=True), ], True,
                  ),
                 ("dev-libs/A-4_beta1-r1",
                  [Atom("dev-libs/*", allow_wildcard=True),
                   Atom("=*/*-*_beta*", allow_wildcard=True),
                   ], [Atom("=*/*-*_beta*", allow_wildcard=True),
                       Atom("dev-libs/*", allow_wildcard=True), ], True,
                 ...
                 ("dev-libs/A-1:0", [
                     Atom("dev-*/*", allow_wildcard=True),
                     Atom("dev-*/*:0", allow_wildcard=True),
                     Atom("dev-libs/A"),
                     Atom("<=dev-libs/A-2"),
                     Atom("dev-libs/A:0"),
                     Atom("=dev-libs/A-1*"),
