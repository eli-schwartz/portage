    ...
    def testMatch_from_list(self):
        tests = (("=sys-apps/portage-45*", [],
                 ...
                 ("sys-apps/portage:0", [Package("=sys-apps/portage-045:0")], ["sys-apps/portage-045"],
                  ), ("sys-apps/portage:0", [Package("=sys-apps/portage-045:1")], []), ("=cat/pkg-1-r1*",
                                                                                        ["cat/pkg-1_alpha1"], []),
                 ...
                 ("=cat/pkg-1.1*", ["cat/pkg-1.1-r1", "cat/pkg-1.10-r1"], ["cat/pkg-1.1-r1"],
                      ...
                      []), ("=cat/pkg-1_pre*", ["cat/pkg-1_pre1"],
                            ["cat/pkg-1_pre1"]), ("=cat/pkg-1-r1*", ["cat/pkg-1-r1"], ["cat/pkg-1-r1"]),
                 ("=cat/pkg-1-r11*", ["cat/pkg-1-r11"], ["cat/pkg-1-r11"]), ("=cat/pkg-1-r11*", ["cat/pkg-01-r11"], [
                     "cat/pkg-01-r11"
                 ]), ("=cat/pkg-01-r11*", ["cat/pkg-1-r11"],
                      ["cat/pkg-1-r11"]), ("=cat/pkg-01-r11*", ["cat/pkg-001-r11"], ["cat/pkg-001-r11"]),
                 ("=sys-fs/udev-1*", ["sys-fs/udev-123", "sys-fs/udev-123-r1"],
                  []), ("=sys-fs/udev-123*", ["sys-fs/udev-123"],
                        ["sys-fs/udev-123"]), ("=sys-fs/udev-123*", ["sys-fs/udev-123-r1"], ["sys-fs/udev-123-r1"]),
                 ("=sys-fs/udev-4*", ["sys-fs/udev-456", "sys-fs/udev-456-r1"],
                  []), ("=sys-fs/udev-456*", ["sys-fs/udev-456"], ["sys-fs/udev-456"]), ("*/*", ["sys-fs/udev-456"], [
                      "sys-fs/udev-456"
                  ]), ("*/*:0", ["sys-fs/udev-456:0"], ["sys-fs/udev-456:0"]), ("*/*:1", ["sys-fs/udev-456:0"], []),
                 ("sys-fs/*", ["sys-fs/udev-456"], ["sys-fs/udev-456"]), ("*/udev", ["sys-fs/udev-456"], [
                     "sys-fs/udev-456"
                          ...
                          ), ("dev-libs/*", ["sys-apps/portage-2.1.2"], []), ("*/tar", ["sys-apps/portage-2.1.2"], []),
                 ("*/*", ["dev-libs/A-1",
                          "dev-libs/B-1"], ["dev-libs/A-1",
                                            "dev-libs/B-1"]), ("dev-libs/*", ["dev-libs/A-1",
                                                                              "sci-libs/B-1"], ["dev-libs/A-1"]),
                 ("dev-libs/A[foo]", [Package("=dev-libs/A-1[foo]"),
                                      Package("=dev-libs/A-2[-foo]")], ["dev-libs/A-1"],
                  ), ("dev-libs/A[-foo]", [Package("=dev-libs/A-1[foo]"),
                                           Package("=dev-libs/A-2[-foo]")], ["dev-libs/A-2"],
                      ), ("dev-libs/A[-foo]", [Package("=dev-libs/A-1[foo]"),
                                               Package("=dev-libs/A-2")], [],
                          ), ("dev-libs/A[foo,bar]", [Package("=dev-libs/A-1[foo]"),
                                                      Package("=dev-libs/A-2[-foo]")], [],
                              ),
                 ("dev-libs/A[foo,bar]", [Package("=dev-libs/A-1[foo]"),
                                          Package("=dev-libs/A-2[-foo,bar]")], [],
                  ), ("dev-libs/A[foo,bar]", [Package("=dev-libs/A-1[foo]"),
                                              Package("=dev-libs/A-2[foo,bar]")], ["dev-libs/A-2"],
                      ), ("dev-libs/A[foo,bar(+)]", [Package("=dev-libs/A-1[-foo]"),
                                                     Package("=dev-libs/A-2[foo]")], ["dev-libs/A-2"],
                          ), ("dev-libs/A[foo,bar(-)]", [Package("=dev-libs/A-1[-foo]"),
                                                         Package("=dev-libs/A-2[foo]")], [],
                              ),
                 ("dev-libs/A[foo,-bar(-)]", [Package("=dev-libs/A-1[-foo,bar]"),
                                              Package("=dev-libs/A-2[foo]")], ["dev-libs/A-2"],
                  ), ("dev-libs/A::repo1", [Package("=dev-libs/A-1::repo1"),
                                            Package("=dev-libs/A-1::repo2")], ["dev-libs/A-1::repo1"],
                      ), ("dev-libs/A::repo2", [Package("=dev-libs/A-1::repo1"),
                                                Package("=dev-libs/A-1::repo2")], ["dev-libs/A-1::repo2"],
                          ), ("dev-libs/A::repo2[foo]",
                              [Package("=dev-libs/A-1::repo1[foo]"),
                               Package("=dev-libs/A-1::repo2[-foo]"), ], [],
                              ), ("dev-libs/A::repo2[foo]",
                                  [Package("=dev-libs/A-1::repo1[-foo]"),
                                   Package("=dev-libs/A-1::repo2[foo]"), ], ["dev-libs/A-1::repo2"],
                                  ), ("dev-libs/A:1::repo2[foo]",
                                      [Package("=dev-libs/A-1:1::repo1"),
                                       Package("=dev-libs/A-1:2::repo2")], [],
                                      ), ("dev-libs/A:1::repo2[foo]",
                                          [Package("=dev-libs/A-1:2::repo1"),
                                           Package("=dev-libs/A-1:1::repo2[foo]"), ], ["dev-libs/A-1::repo2"],
                                          ),
