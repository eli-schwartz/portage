    ...
    def testMatch_from_list(self):
        tests = (
            ...
            ("=cat/pkg-1.1*", ["cat/pkg-1.1-r1", "cat/pkg-1.10-r1"], ["cat/pkg-1.1-r1"],
             ), ("=cat/pkg-1-r1*", ["cat/pkg-1-r11"], []), ("=cat/pkg-1_pre*", ["cat/pkg-1_pre1"], [
                 "cat/pkg-1_pre1"
             ]), ("=cat/pkg-1-r1*", ["cat/pkg-1-r1"],
                  ["cat/pkg-1-r1"]), ("=cat/pkg-1-r11*", ["cat/pkg-1-r11"], ["cat/pkg-1-r11"]),
            ("=cat/pkg-1-r11*", ["cat/pkg-01-r11"], ["cat/pkg-01-r11"]), ("=cat/pkg-01-r11*", [
                "cat/pkg-1-r11"
            ...
            ("=sys-fs/udev-1*", ["sys-fs/udev-123", "sys-fs/udev-123-r1"],
             []), ("=sys-fs/udev-123*", ["sys-fs/udev-123"],
                   ["sys-fs/udev-123"]), ("=sys-fs/udev-123*", ["sys-fs/udev-123-r1"], [
                       "sys-fs/udev-123-r1"
                   ]), ("=sys-fs/udev-4*", ["sys-fs/udev-456", "sys-fs/udev-456-r1"],
                        []), ("=sys-fs/udev-456*", ["sys-fs/udev-456"], ["sys-fs/udev-456"]),
            ("*/*", ["sys-fs/udev-456"], ["sys-fs/udev-456"]), ("*/*:0", ["sys-fs/udev-456:0"], [
                "sys-fs/udev-456:0"
            ]), ("*/*:1", ["sys-fs/udev-456:0"],
                 []), ("sys-fs/*", ["sys-fs/udev-456"],
                       ["sys-fs/udev-456"]), ("*/udev", ["sys-fs/udev-456"], ["sys-fs/udev-456"]),
            ("=sys-apps/portage-2*", ["sys-apps/portage-2.1"], ["sys-apps/portage-2.1"],
                     ...
                     []), ("*/tar", ["sys-apps/portage-2.1.2"],
                           []), ("*/*", ["dev-libs/A-1", "dev-libs/B-1"],
                                 ["dev-libs/A-1",
                                  "dev-libs/B-1"]), ("dev-libs/*", ["dev-libs/A-1", "sci-libs/B-1"],
                                                     ["dev-libs/A-1"]),
