    ...
    def testAtom(self):
        tests = (
            ...
            (
                ...
                ("=*", "sys-apps/portage", "2.1-r1", "0", "[doc]", None),
                False,
                False,
            ),
            (
                "sys-apps/portage:0[doc]",
                (None, "sys-apps/portage", None, "0", "[doc]", None),
                False,
                False,
            ),
            (
            ...
            (
                "=*/*-*_beta*:0::repo_name",
                ("=*", "*/*", "*_beta*", "0", None, "repo_name"),
                True,
                True,
            ),
            ("sys-apps/*", (None, "sys-apps/*", None, None, None, None), True, False),
            ("*/portage", (None, "*/portage", None, None, None, None), True, False),
            (
                "s*s-*/portage:1",
                (None, "s*s-*/portage", None, "1", None, None),
                True,
                False,
            ),
            ("*/po*ge:2", (None, "*/po*ge", None, "2", None, None), True, False),
            ("!dev-libs/A", (None, "dev-libs/A", None, None, None, None), True, True),
            ("!!dev-libs/A", (None, "dev-libs/A", None, None, None, None), True, True),
            ("!!dev-libs/A", (None, "dev-libs/A", None, None, None, None), True, True),
            (
                "dev-libs/A[foo(+)]",
                (None, "dev-libs/A", None, None, "[foo(+)]", None),
                True,
                True,
            ),
            (
            ...
            (
                ...
                ("=*", "sys-apps/portage", "2.1-r1", "0", "[doc]", "repo_name"),
                False,
                True,
            ),
            (
                "sys-apps/portage:0::repo_name[doc]",
                (None, "sys-apps/portage", None, "0", "[doc]", "repo_name"),
                False,
                True,
            ),
            (
                "*/*::repo_name",
                (None, "*/*", None, None, None, "repo_name"),
                True,
                True,
            ),
            (
                "sys-apps/*::repo_name",
                (None, "sys-apps/*", None, None, None, "repo_name"),
                True,
                True,
            ),
            (
                "*/portage::repo_name",
                (None, "*/portage", None, None, None, "repo_name"),
                True,
                True,
            ),
            (
                "s*s-*/portage:1::repo_name",
                (None, "s*s-*/portage", None, "1", None, "repo_name"),
                True,
                True,
            ),
        )
