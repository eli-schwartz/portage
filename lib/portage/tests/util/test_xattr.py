...
class SystemCommandsTest(TestCase):
    ...
    OUTPUT = "\n".join(("# file: /bin/ping", "security.capability=0sAQAAAgAgAAAAAAAAAAAAAAAAAAA=",
                        'user.foo="asdf"', "",
                        ))
    ...
    def testGetAllParsing(self):
        ...
        with mock.patch.object(subprocess, "Popen") as call_mock:
            ...
            exp = [(b"security.capability", b"0sAQAAAgAgAAAAAAAAAAAAAAAAAAA="),
                   (b"user.foo", b'"asdf"'), ]
