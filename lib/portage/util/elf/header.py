...
from portage.util.endian.decode import (decode_uint16_le, decode_uint32_le, decode_uint16_be,
                                        decode_uint32_be,
                                        )
from portage.util.elf.constants import (E_ENTRY, E_MACHINE, E_TYPE, EI_CLASS, ELFCLASS32,
